...
export const metadata = {
  title: "About Us - Ax Scientific",
  description: "Ax Scientific has quickly established itself as the new standard in executive search",
}
      ...
      <main className="bg-background">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                Ax Scientific has quickly established itself as the new standard in executive search—delivering
        ...
        <section className="py-16">
          ...
          >
            <div className="space-y-6 text-lg text-muted-foreground">
              <p className="leading-relaxed">
                Ax Scientific leads with a true partnership mindset, beginning every engagement with deep, active
                listening. We work to understand each client's ideal vision for a critical role—down to culture fit,
        ...
        <section className="py-16 bg-muted/30">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                At Ax Scientific, complacency is not an option. Our reputation rests on an unyielding commitment to
              ...
              <p className="leading-relaxed">
                ...
                Supported by a fortified infrastructure and a deeply experienced team, Ax Scientific is positioned to
        ...
        <section className="py-16">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                Executives who prioritize precision and strategic clarity increasingly turn to Ax Scientific, confident
                that their career trajectory is supported by a firm equipped with exceptional analytical and advisory
                capability. Our ability to transform talent acquisition into a disciplined, strategic function has
                positioned Ax Scientific as the definitive partner for this critical stage of organizational and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8 items-start">
              <div className="space-y-6 text-lg text-muted-foreground">
                <p className="leading-relaxed">
                  At the center of this advantage is Ax Scientific's proprietary A-Frame Intelligence Engine, a
        ...
        <section className="py-16 bg-muted/30">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-12">
              <p className="leading-relaxed">
                Surpassing the limits of traditional senior-leadership evaluation, Ax Scientific is equipped to execute
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  For example, in our growing education division, Ax Scientific maintains strong global relationships
                  with school presidents, deans, vice chairs, chancellors, athletic directors, and other key educational
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ax Scientific's boutique model is built to drive impact—serving as a catalyst in some of the most
