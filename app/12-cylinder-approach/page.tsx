...
export const metadata = {
  title: "12 Cylinder Approach - Ax Frisco",
        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-16">
              ...
              information. Ax Frisco delivers the insights, systems, and support needed to create and manage this
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  Ax Frisco rejects cookie-cutter solutions. Just as a high-performance engine depends on every
              ...
              <div className="space-y-4">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  ...
                  growth. Ax Frisco prioritizes deeper analysis, meaningful metrics, and reliable insight—ensuring
              ...
              <div className="space-y-4">
                ...
                <p className="text-base text-muted-foreground leading-relaxed">
                  Ax Frisco operates with intentional focus, ensuring every initiative is actively powered—not left
