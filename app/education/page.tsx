        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Within higher education, Ax Scientific has built a proven track record of sourcing and placing
              distinguished academic leaders for respected universities and private institutions. This success is
              supported by our deep engagement with presidents, provosts, chancellors, vice presidents, deans, faculty
              leadership, coaches, alumni, and additional decision-makers who play a central role in selecting
              candidates for pivotal leadership roles.
            </p>
              ...
              <div className="flex-1">
                ...
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    reaching senior leaders, yet Ax Scientific's industry relationships and extensive resources allow
