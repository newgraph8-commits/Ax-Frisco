        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Scientific develops advanced, adaptive SEO frameworks that align with audience behavior, expand
              visibility, and strengthen an organization's digital presence across key channels.
            </p>
                        ...
                        <Link
                          ...
                          className={`block w-full text-left px-4 py-3 rounded-md text-sm font-medium transition-colors ${
                            activeSection === item.id
                              ...
                              : "text-gray-700 hover:bg-[#FFD500] hover:text-black"
                          }`}
                        >
                          {item.label}
                        </Link>
                ...
                <div className="space-y-8 w-full">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-6">
                      Ax Scientific brings the technical depth and strategic foresight needed to expand, refine, and
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      Ax Scientific treats local visibility as a growth accelerator. We uncover the keywords, visuals,
                      and content angles that lead to community dominance—helping your business carve out a durable,
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      Ax Scientific understands exactly why the platform performs at that scale.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      ...
                      substantially. This multi-channel dynamic has enabled Ax Scientific clients to achieve stronger
                      click through rate (CTR) results and expanded audience reach.
                    </p>
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full">
                      ...
                      Scientific ensures that clients leverage this environment to its fullest potential.
                    </p>
                  </div>
                    ...
                    <div className="space-y-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed w-full">
                          ...
                          Scientific for the technical capabilities and operational support required to launch
                          effectively, scale efficiently, and monetize successfully.
                        </p>
                      </div>
