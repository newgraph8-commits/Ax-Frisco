        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Frisco develops advanced, adaptive SEO frameworks that align with audience behavior, expand
                ...
                <div className="space-y-8 w-full">
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-6">
                      Ax Frisco brings the technical depth and strategic foresight needed to expand, refine, and
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      Ax Frisco treats local visibility as a growth accelerator. We uncover the keywords, visuals,
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      Ax Frisco understands exactly why the platform performs at that scale.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed w-full mb-4">
                      ...
                      substantially. This multi-channel dynamic has enabled Ax Frisco clients to achieve stronger
