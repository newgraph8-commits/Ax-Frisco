              ...
              <div className="flex-1">
                ...
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    long-term strategic vision. Ax Frisco has grown in step with this pace, providing executive
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    of Ax Frisco's board, whose insight and discipline help ensure our work remains focused,
