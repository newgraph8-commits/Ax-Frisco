            ...
            <div className="grid grid-cols-1 lg:grid-cols-[256px_1fr] gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="relative w-full h-[400px] rounded-lg overflow-hidden mb-8">
                  <Image
                    src="/professional-recruitment-interview-business-office.jpg"
                ...
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    long-term strategic vision. Ax Scientific has grown in step with this pace, providing executive
                    search solutions that translate complex information into clear, actionable leadership strategies.
                    Clients draw on the firm's extensive experience in board governance, management consulting, and
                    senior-level recruitment—expertise that informs every engagement we undertake.
                  </p>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    of Ax Scientific's board, whose insight and discipline help ensure our work remains focused,
                    precise, and aligned with the needs of diverse industries.
                  </p>
                </div>
              </div>
            </div>
