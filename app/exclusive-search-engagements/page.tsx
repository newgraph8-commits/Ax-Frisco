        ...
        <section className="pt-48 pb-12 lg:pt-56 lg:pb-16">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              ...
              Ax Scientific's consultants ensure that every engagement makes the most effective use of time, resources,
              and overall impact. Our firm delivers service models that are fully customized to the needs of each
              client, regardless of scale or complexity.
            </p>
            ...
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Ax Scientific remains the sole point of contact from the initial search through a candidate's
                integration, ensuring consistency and avoiding the handoff model used by many firms. This continuity
                allows organizations and newly placed leaders to feel supported through every stage of a high-stakes
